export default async function handler(req, res) {
  const transport = {
    ...
    port: process.env.SOCKETLABS_PORT,
    // eslint-disable-next-line no-undef
    host: process.env.SOCKETLABS_ADDRESS,
    auth: {
      // eslint-disable-next-line no-undef
      user: process.env.SOCKETLABS_SERVER_NAME,
      // eslint-disable-next-line no-undef
      pass: process.env.SOCKETLABS_SERVER_PASSWORD
    }
  }
  ...
  try {
    ...
    const mailData = {
      from: req.body.email,
      // eslint-disable-next-line no-undef
      to: process.env.SOCKETLABS_EMAIL,
