        ...
        <S.Calculadora>
            ...
            <div id={'middle'}>
                <div id={"form"}>
                    <label>
                        Comprimento:
                        <input type={"text"} id={"comprimento"} placeholder={"00.00cm"}/>
                    </label>
                    <label>
                        Altura:
            ...
            <div id={'bottom'}>
                <p>Resultado:</p>
                <p>Valor varia entre: <strong>R$ {Result}</strong> a R$ <strong>{Result2}</strong></p>
               
                <p>Tamanho em M²: <strong>{MetroQuad}m²</strong></p>
